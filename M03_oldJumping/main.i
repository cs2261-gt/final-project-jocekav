...
# 1 "splash1.h" 1
# 22 "splash1.h"
extern const unsigned short splash1Tiles[2608];


extern const unsigned short splash1Map[1024];
...
void goToStart() {
    ...
    DMANow(3, splash1Pal, ((unsigned short *)0x5000000), 256);
    DMANow(3, splash1Tiles, &((charblock *)0x6000000)[0], 5216 / 2);
    DMANow(3, splash1Map, &((screenblock *)0x6000000)[28], 1024 * 4);
    hideSprites();
...
void start() {
    ...
    if ((!(~(oldButtons)&((1<<8))) && (~buttons & ((1<<8))))) {
        DMANow(3, splash2Pal, ((unsigned short *)0x5000000), 256);
        DMANow(3, splash2Tiles, &((charblock *)0x6000000)[0], 5184 / 2);
        DMANow(3, splash2Map, &((screenblock *)0x6000000)[28], 1024 * 4);
        startScreen = 1;
    }
    if (!startScreen && (!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
        goToInstruct();
    }
    if (startScreen && (!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
...
void goToInstruct(){
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 704 / 2);
...
void goToGame() {
    ...
    DMANow(3, gameBgTiles, &((charblock *)0x6000000)[0], 896 / 2);
...
void goToPause() {
    ...
    DMANow(3,pauseBgTiles, &((charblock *)0x6000000)[0], 7680 / 2);
...
void goToLose() {
    ...
    DMANow(3,loseBgTiles, &((charblock *)0x6000000)[0], 6528 / 2);
